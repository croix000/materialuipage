...
function Store(props) {
  ...
  if (props.storeLink == 'no') {
    return <Button variant="contained" size="large" className={props.classes} >
      <GetAppIcon></GetAppIcon> UNAVAILABLE
  </Button>;
  }
  else {

    return <Button variant="contained" size="large" className={props.classes} onclick={() => window.location.replace(link)} href={props.storeLink}>
        ...
        >
          ...
          >
            ...
            <div style={landscape ? { minWidth: 300, maxWidth: 'calc(50% - 48px)', padding: 24, float: 'right' } : null}>
              <div
                className={classNames(classes.footerS, {
                  [classes.footerMobileS]: mobile,
                  [classes.footerMobileLandscapeS]: landscape
                })}
              >
                ...
                <Store storeLink={storeLink} classes={classes.margin} />
